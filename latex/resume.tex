...
\begin{grouping}{Academic Research \hfill (In Progress)}
    ...
    \item {\bf Updatable PSI Revisited: Deletion, Cardinality, Sum, and Secret Sharing. } \\
        ...
        \begin{items}
            ...
            % \item Jointly developed protocol prototype for experimental evaluation.
        \end{items}
...
\begin{grouping}{Employment}
    ...
    \item {\bf Microsoft } \hfill Redmond, WA \\
        ...
        \begin{items}
            ...
            % \item Updated the reporting service deployment system and deployed to sovereign clouds
...
\item {\bf University of Pennsylvania } \hfill Philadelphia, PA \\
    ...
    \begin{items}
        ...
        % \item Planned and led weekly staff meetings and training sessions \\
    \end{items}
